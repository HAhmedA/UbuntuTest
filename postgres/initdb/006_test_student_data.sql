...
BEGIN
    ...
    -- 7d annotations
    INSERT INTO public.srl_annotations (user_id, concept_key, time_window, avg_score, min_score, max_score, response_count, trend, is_inverted, has_sufficient_data, distinct_day_count, annotation_text, annotation_text_llm, computed_at) VALUES
    (test_user_id, 'efficiency', '7d', 3.79, 2, 5, 14, 'improving', false, true, 7, 'Your Efficiency has been improving over the past 7 days, with an average of 3.8 out of 5.', 'Regarding "I believe I can accomplish my learning duties and learning tasks efficiently": The student''s responses have been improving over the past 7 days. Statistics: average 3.8, min 2, max 5 (based on 14 responses).', NOW()),
    ...
    (test_user_id, 'tracking', '7d', 2.79, 2, 5, 14, 'declining', false, true, 7, 'Your Tracking has been declining over the past 7 days, with an average of 2.8 out of 5.', 'Regarding "I am keeping track of what I need to do or accomplish": The student''s responses have been declining over the past 7 days. Statistics: average 2.8, min 2, max 5 (based on 14 responses).', NOW()),
    ...
    (test_user_id, 'effort', '7d', 3.43, 1, 5, 14, 'improving', false, true, 7, 'Your Effort has been improving over the past 7 days, with an average of 3.4 out of 5.', 'Regarding "I am putting enough effort into my learning tasks to accomplish them well": The student''s responses have been improving over the past 7 days. Statistics: average 3.4, min 1, max 5 (based on 14 responses).', NOW()),
    ...
    (test_user_id, 'help_seeking', '7d', 3.64, 1, 5, 14, 'improving', false, true, 7, 'Your Help Seeking has been improving over the past 7 days, with an average of 3.6 out of 5.', 'Regarding "I seek help from teachers, friends, or the internet when I need explanation or help with difficult tasks": The student''s responses have been improving over the past 7 days. Statistics: average 3.6, min 1, max 5 (based on 14 responses).', NOW()),
    ...
    (test_user_id, 'timeliness', '7d', 2.57, 2, 4, 14, 'declining', false, true, 7, 'Your Timeliness has been declining over the past 7 days, with an average of 2.6 out of 5.', 'Regarding "I am doing my studies on time and keeping up with tasks/deadlines": The student''s responses have been declining over the past 7 days. Statistics: average 2.6, min 2, max 4 (based on 14 responses).', NOW()),
    (test_user_id, 'motivation', '7d', 3.43, 1, 5, 14, 'fluctuating', false, true, 7, 'Your Motivation has been fluctuating over the past 7 days, with an average of 3.4 out of 5.', 'Regarding "I feel enthusiastic/motivated to learn, understand, and get better grades": The student''s responses have been fluctuating over the past 7 days. Statistics: average 3.4, min 1, max 5 (based on 14 responses).', NOW()),
    (test_user_id, 'anxiety', '7d', 2.57, 1, 5, 14, 'improving', true, true, 7, 'Your Anxiety has been decreasing (which is good) over the past 7 days, with an average of 2.6 out of 5.', 'Regarding "I feel anxious/stressed working on learning tasks, assignments, or in class": The student''s responses have been decreasing (which is good) over the past 7 days. Statistics: average 2.6, min 1, max 5 (based on 14 responses).', NOW()),
    ...
    (test_user_id, 'learning_from_feedback', '7d', 4.14, 2, 5, 14, 'improving', false, true, 7, 'Your Learning from Feedback has been improving over the past 7 days, with an average of 4.1 out of 5.', 'Regarding "I am learning from feedback and mistakes to accomplish my learning": The student''s responses have been improving over the past 7 days. Statistics: average 4.1, min 2, max 5 (based on 14 responses).', NOW()),
